...
from robohang.policy.funnel.predict_coverage import (
    make_coverage_dataset, 
    CoverageModule,  
)
...
def main(cfg: omegaconf.DictConfig):
    ...
    trds, vlds = make_coverage_dataset(
    ...
    if ckpt_path is not None:
        model = CoverageModule.load_from_checkpoint(
