...
from robohang.policy.funnel.funnel_policy import FunnelPolicyRandom
...
def main(cfg: omegaconf.DictConfig):
    ...
    funnel_policy = FunnelPolicyRandom(funnel_gym, cfg.funnel_policy)
    ...
    for traj_idx in tqdm.tqdm(range(output_cfg.total_traj), dynamic_ncols=True):
        ...
        for trial_idx in tqdm.tqdm(range(output_cfg.num_trial), dynamic_ncols=True):
            action_and_info = funnel_policy.get_fling_action()
