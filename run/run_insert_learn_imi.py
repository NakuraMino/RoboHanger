...
from robohang.policy.insert.insert_learn_imi import (
    make_insert_dataset,
    InsertLeftEndImiModule,
    InsertRightEndImiModule
)
...
def main(cfg: omegaconf.DictConfig):
    ...
    # training
    action_type_to_cls = dict(left=InsertLeftEndImiModule, right=InsertRightEndImiModule)
    cls = action_type_to_cls[cfg.run.endpoint]
