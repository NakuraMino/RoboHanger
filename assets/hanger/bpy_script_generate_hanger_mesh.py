...
boolean_modifier.object = bpy.data.objects["ico"]
...
bpy.data.objects["arm"].hide_set(True)
bpy.data.objects["ico"].hide_set(True)
...
if add_rack:
    ...
    obj = bpy.context.object
    obj.name = "rack"
    obj.scale = (0.005, 0.005, 0.180)
    obj.rotation_euler = (0, np.pi / 2, 0)
    obj.location = (0, -0.083, 0)
    obj.hide_set(True)
